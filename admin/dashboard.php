...
/**
 * Placeholder for the OptiCore dashboard view.
 *
 * Keeping this file avoids routing errors when the submenu loads it. Add
 * analytics or quick actions here in future iterations. 📊
 *
 * Example ideas for future enhancements:
 * - A quick summary of enabled optimisation features.
 * - Simple performance tips or links to documentation.
...
<div class="flex flex-col gap-4">
    ...
    <header class="bg-linear-to-br from-sky-400 to-violet-500 flex justify-between items-center p-6 shadow-lg rounded-lg">
        <h1 class="p-0 text-white! flex! items-center gap-4">
            ...
            <?php _e('Opticore', 'opticore'); ?>
        </h1>
    </header>

    <div class="grid grid-cols-12 grid-rows-8 gap-4">

        <div class="col-span-10 row-span-3 bg-white shadow-lg p-6 rounded-lg">
            <div class="flex justify-between items-center">
                <h2 class="mx-0! p-0!"><?php _e('Performance Overview', 'opticore'); ?></h2>
                ...
                <form class="pagespeed-api-key flex gap-2 items-center" method="post">
                    <label class="relative">
                        ...
                        <button type="submit" class="shadow-lg flex gap-2 py-2 px-4 bg-sky-400 items-center text-white font-bold! rounded-full cursor-pointer group absolute right-2 top-1/2 -translate-y-1/2">
                            ...
                            <?php _e('Save', 'opticore'); ?>
                        </button>
                    </label>
                    <button type="button" class="shadow-lg flex gap-2 py-2 px-4 bg-slate-400 items-center text-white font-bold! rounded-full cursor-pointer group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" class="group-hover:animate-spin" aria-hidden="true">
                            <path fill="currentColor" d="M16 4c-5.113 0-9.383 3.16-11.125 7.625l1.844.75C8.176 8.641 11.71 6 16 6c3.242 0 6.133 1.59 7.938 4H20v2h7V5h-2v3.094A11.94 11.94 0 0 0 16 4m9.281 15.625C23.824 23.359 20.29 26 16 26c-3.277 0-6.156-1.613-7.969-4H12v-2H5v7h2v-3.094C9.188 26.386 12.395 28 16 28c5.113 0 9.383-3.16 11.125-7.625z" />
                        </svg>
                        <?php _e('Re-Test', 'opticore'); ?>
                    </button>
                </form>
            </div>
        ...
        <div class="col-span-2 row-span-3 col-start-11 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-2 row-span-2 row-start-4 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-2 row-span-2 col-start-3 row-start-4 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-2 row-span-2 col-start-5 row-start-4 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-4 row-span-2 col-start-7 row-start-4 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-2 row-span-3 col-start-11 row-start-4 bg-white shadow-lg p-6 rounded-lg"></div>

        <div class="col-span-10 row-start-6 bg-white shadow-lg p-6 rounded-lg"></div>
